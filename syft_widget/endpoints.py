"""Fixed endpoint registry for syft-widget
All endpoints are defined here at module level so they can be pickled.
Both client and server have access to these same endpoints.
"""
import time
import random
